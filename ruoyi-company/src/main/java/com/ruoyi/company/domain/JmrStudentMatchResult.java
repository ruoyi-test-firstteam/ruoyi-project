 ...
 * @date 2020-09-30
 */
public class JmrStudentMatchResult extends BaseEntity
{
    ...
    public JmrStudentMatchResult() {
    }

    public JmrStudentMatchResult(Integer smrId, Integer smrCId, Integer smrJId, Integer smrSId, Integer smrRId, Integer smrBId, Integer smrValue) {
        this.smrId = smrId;
        this.smrCId = smrCId;
        this.smrJId = smrJId;
        this.smrSId = smrSId;
