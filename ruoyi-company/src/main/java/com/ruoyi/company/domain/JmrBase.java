...
public class JmrBase {
    ...
    public JmrBase(Integer smr_b_id, Integer smr_sex_value, Integer smr_level_value, Integer smr_profession_value, Integer smr_history_value, Integer smr_language_value, Integer smr_range_value, Integer smr_position_value, Integer jmr_city_value) {
        this.smr_b_id = smr_b_id;
        this.smr_sex_value = smr_sex_value;
        this.smr_level_value = smr_level_value;
        this.smr_profession_value = smr_profession_value;
